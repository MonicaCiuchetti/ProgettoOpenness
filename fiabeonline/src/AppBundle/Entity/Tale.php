...
class Tale
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Sequence", mappedBy="tale", orphanRemoval=true, cascade={"persist"}, cascade={"remove"})
     */
    private $sequences;

    /**
     * @ORM\OneToMany(targetEntity="TaleGenre", mappedBy="tale", cascade={"remove"})
     */
    private $taleGenres;
